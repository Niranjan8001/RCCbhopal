...
const projects = [
  ...
  },
  {
    ...
    year: '2025',
    color: '#AF52DE',
    description: 'An architectural masterpiece in Aakriti Aqua City, Bhopal, engineered with premium reinforced concrete foundations, expansive double-glazed glass facades, and a luxury multi-tiered structural design.',
    image: '/proj2.jpeg',
  },
  {
    ...
    year: '2025',
    color: '#FF9F0A',
    description: 'A bespoke residential build in the heart of Ramayana Colony, Bhopal — crafted with precision-engineered RCC framing, premium brick masonry, and bespoke interior-finish detailing that blends timeless design with modern structural standards.',
    image: '/proj3.jpeg',
  },
  {
...
export default function ProjectShowcase() {
  ...
  const TOTAL_PAGES = NUM_PROJECTS;
