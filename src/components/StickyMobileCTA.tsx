...
export default function StickyMobileCTA() {
  return (
    ...
    >
      <a
        href="tel:+917987900965"
        onClick={() => trackEvent('phone_click', { source: 'sticky_mobile_cta' })}
      ...
      <div className="sticky-mobile-cta-divider" />
      <a
        ...
        className="sticky-mobile-cta-btn sticky-mobile-cta-btn-primary"
      >
