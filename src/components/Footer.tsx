        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-muted leading-relaxed mb-6 max-w-xs">
              Founded in 2022 and built on 35 years of engineering experience across Madhya Pradesh.
              Luxury homes, design consultancy and government civil works — every rate published upfront.
            </p>
            {/* Social icons */}
            <div className="flex items-center gap-3">
              <a
                href="https://x.com/RCCBhopal"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="RCC on X"
                className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 hover:border-accent-yellow/30 hover:-translate-y-1 transition-all duration-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-yellow"
              >
